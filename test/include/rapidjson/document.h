...
public:
	...
	*/
	GenericDocument(Allocator* allocator = 0, size_t stackCapacity = kDefaultStackCapacity) : stack_(allocator, stackCapacity), parseError_(0), errorOffset_(0), errorLine_(0) {}
	...
	*/
	...
	GenericDocument& ParseStream(Stream& stream) {
		...
		if (reader.template Parse<parseFlags>(stream, *this)) {
			...
			errorLine_ = reader.GetErrorLine();
			ClearStack();
		}
		return *this;
	}
